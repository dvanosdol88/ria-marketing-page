  ...
  return (
    <>
      ...
      <div className="save2-body antialiased min-h-screen">
        {/* Hero Section */}
        <header className="vibrant-gradient text-white pt-16 pb-20 px-4 mb-12 clip-path-slant">
        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24 pb-20">
            ...
            {/* Footer */}
            <footer className="text-center text-slate-500 pt-12 pb-8 border-t border-slate-200 mt-12">
                <p className="text-sm font-semibold mb-2">Sources & Methodology</p>
                <p className="text-xs max-w-2xl mx-auto">
                    Calculations assume a hypothetical $100,000 initial investment with a 7% annual gross return over 30 years. 
                    &quot;Low Fee&quot; model uses 0.1% annual expense ratio. &quot;High Fee&quot; model uses 2.0% annual total cost. 
                    Quotes sourced from published works of J. Siegel, Wall Street Journal, and CFA Institute publications. 
                    Success rate data conceptualized based on Morningstar&apos;s &quot;Mind the Gap&quot; and Active/Passive Barometer studies.
                </p>
                <p className="text-xs mt-4">Generated by Canvas Infographics</p>
            </footer>
