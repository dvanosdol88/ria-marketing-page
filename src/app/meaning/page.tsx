          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              ...
              <div className="bg-white rounded-2xl shadow-sm border-2 border-green-500 p-8 relative overflow-hidden">
                ...
                <div className="relative">
                  <span className="inline-block px-3 py-1 bg-green-100 text-green-600 text-xs font-semibold rounded-full mb-4">THE PURPOSE</span>
                  ...
                  <div className="mt-6 pt-6 border-t border-green-100">
                    <p className="text-sm text-stone-500">My cost: <span className="font-semibold text-green-600">$100/month flat fee</span></p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm border border-stone-200">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="w-16 h-16 rounded-lg bg-green-100 flex items-center justify-center"><span className="text-2xl">🎯</span></div>
        ...
        <section className="bg-white py-24 px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-2xl md:text-3xl font-bold text-stone-800 mb-8">
              ...
              <span className="bg-gradient-to-r from-green-500 to-green-600 bg-clip-text text-transparent">helping you succeed.</span>
            </p>
              ...
              <div className="grid md:grid-cols-2 gap-8 md:gap-16">
                ...
                <div className="relative">
                  <div className="bg-green-50 rounded-3xl p-8 md:p-10 border-2 border-green-200">
                    <div className="flex items-center gap-4 mb-6">
                      <div className="w-14 h-14 rounded-2xl bg-white shadow-sm flex items-center justify-center"><span className="text-3xl">🎯</span></div>
                      <div><p className="text-xs font-semibold text-green-600 uppercase tracking-wide">What you actually need</p><h3 className="text-2xl font-bold text-stone-900">The Purpose</h3></div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl p-4"><p className="text-sm text-stone-500 mb-1">My flat fee</p><p className="text-2xl font-bold text-green-600">$100/month</p><p className="text-xs text-stone-400">($1,200/year, period)</p></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 px-6 bg-neutral-50">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-stone-200">
                <div className="w-12 h-12 rounded-xl bg-green-100 flex items-center justify-center mb-5">
                  <svg className="w-6 h-6 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                </div>
