...
- caveat carried into production: the agreement email still does not send. The confirmation copy is honest about this ("David will email you the advisory agreement") and flips to "check your email" automatically once a provider is wired. Until then, sign-ups arrive as leads that David must action by hand.
